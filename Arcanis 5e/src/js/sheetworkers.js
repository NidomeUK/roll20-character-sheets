    ...
    ['strength','dexterity','constitution','intelligence','wisdom','charisma','blood_rank'].forEach(attr => {
   ...
   ['spell-cantrip','spell-1','spell-2','spell-3','spell-4','spell-5','spell-6','spell-7','spell-8','spell-9'].forEach(attr => {
    ...
    var do_update_tool = function(tool_array) {
        var tool_attribs = ["pb","pb_type","jack","strength_mod","dexterity_mod","constitution_mod","intelligence_mod","wisdom_mod","charisma_mod","blood_rank_mod"];
        var update = {};
        ...
        getAttrs(tool_attribs, function(v) {
            _.each(tool_array, function(tool_id) {
                ...
                if(v["repeating_tool_" + tool_id + "_toolattr_base"] && v["repeating_tool_" + tool_id + "_toolattr_base"].substring(0,2) === "?{") {
                    ...
                    var mod = "?{Attribute?|Strength,@{strength_mod}|Dexterity,@{dexterity_mod}|Constitution,@{constitution_mod}|Intelligence,@{intelligence_mod}|Wisdom,@{wisdom_mod}|Charisma,@{charisma_mod}|Blood Rank,@{blood_rank_mod}}";
    ...
    var processDrop = function(page, currentData, repeating, looped) {
        ...
        var parseValues = function(uses_string) {
            var attribs = ["strength", "dexterity", "constitution", "wisdom", "intelligence", "charisma", "blood_rank"];
        ...
        if(category === "Monsters") {
            ...
            //ABILITY SCORES
            const npcAbilites = ["strength", "dexterity", "constitution", "intelligence", "wisdom", "charisma", "blood_rank"];
        ...
        if(category === "Proficiencies") {
            ...
            if (type.toLowerCase() === "language" || type.toLowerCase() === "armor" || type.toLowerCase() === "weapon" || type.toLowerCase() === "other") {
                ...
                if(!existing.base) update[`repeating_tool_${newrowid}_toolattr_base`] = "?{Attribute?|Strength,@{strength_mod}|Dexterity,@{dexterity_mod}|Constitution,@{constitution_mod}|Intelligence,@{intelligence_mod}|Wisdom,@{wisdom_mod}|Charisma,@{charisma_mod}|Blood Rank,@{blood_rank_mod}}";
    ...
    const update_attacks = (update_id, source) => {
        ...
        } else if (["strength","dexterity","constitution","intelligence","wisdom","charisma","blood_rank","spells","all"].indexOf(update_id) > -1) {
    ...
    const do_update_attack = (attack_array, source) => {
        let attack_attribs = ["level","d20","pb","pb_type","pbd_safe","dtype","globalmagicmod","strength_mod","dexterity_mod","constitution_mod","intelligence_mod","wisdom_mod","charisma_mod","blood_rank_mod","spellcasting_ability","spell_save_dc","spell_attack_mod", "spell_dc_mod", "global_damage_mod_roll", "global_damage_mod_crit"];
    ...
    var update_ac = function() {
        getAttrs(["custom_ac_flag"], function(v) {
            if(v.custom_ac_flag === "2") {
                ...
                var update = {};
                var ac_attrs = ["simpleinventory","custom_ac_base","custom_ac_part1","custom_ac_part2","strength_mod","dexterity_mod","constitution_mod","intelligence_mod","wisdom_mod","charisma_mod","blood_rank_mod", "custom_ac_shield"];
    ...
    const update_class = () => {
        getAttrs(["class", "base_level","custom_class","cust_hitdietype","cust_spellcasting_ability","cust_strength_save_prof","cust_dexterity_save_prof","cust_constitution_save_prof","cust_intelligence_save_prof","cust_wisdom_save_prof","cust_charisma_save_prof", "npc"], (v) => {
            ...
            const abilites = ["Strength", "Dexterity", "Constitution", "Intelligence", "Wisdom", "Charisma", "Blood Rank"];
            //Custom Classes
    ...
    var update_spell_info = function(attr) {
        var update = {};
        getAttrs(["spellcasting_ability","spell_dc_mod","globalmagicmod","strength_mod","dexterity_mod","constitution_mod","intelligence_mod","wisdom_mod","charisma_mod","blood_rank_mod"], function(v) {
    ...
    var check_l1_mancer = function() {
        getAttrs(["class", "base_level", "strength_base","dexterity_base","constitution_base","intelligence_base","wisdom_base","charisma_base","blood_rank_base","l1mancer_status","version","charactermancer_step"], function(v) {
    ...
    var check_lp_mancer = function() {
        getAttrs(["class", "base_level", "strength_base","dexterity_base","constitution_base","intelligence_base","wisdom_base","charisma_base","blood_rank_base","l1mancer_status", "lpmancer_status","version","charactermancer_step"], function(v) {
